...
function setToArray(mySet) {
	...
	return [...mySet].filter((el) => typeof el === "string").sort();
}
...
function getDifference(set1, set2) {
	...
	const differenceSet = set1;
	for (const value of differenceSet) {
		if (set2.has(value)) {
